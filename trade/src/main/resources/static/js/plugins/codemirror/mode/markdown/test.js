...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link customer@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <customer@example.com>] foo");

  MT("linkEmailDouble",
     "[link <customer@example.com>] foo [link <customer@example.com>]");
