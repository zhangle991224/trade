...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		else
		{
			...
			/* Don't require that the customer must specify bRegex, bSmart or bCaseInsensitive */
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			// data, assign any customer defined widths, then insert it into the DOM and
			...
			// the table width should be by summing the customer given values, and the
			// automatic values
			if ( scrollX )
			{
				var total = 0;
